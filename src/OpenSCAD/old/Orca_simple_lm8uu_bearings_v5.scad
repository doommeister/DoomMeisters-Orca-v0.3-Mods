...
color("green")translate([20,20+Z_BLOCK_LENGTH+LENGTH_INC,Z_BLOCK_HEIGHT*1.2-Z_BLOCK_CLEARANCE])rotate([180,0,0])orca_lm8uu_edge_double(switch_nub=true);
color("blue")translate([55,20+Z_BLOCK_LENGTH_V3,Z_BLOCK_HEIGHT*1.2-Z_BLOCK_CLEARANCE])rotate([180,0,0])orca_z_axis_lm8uu_single();
color("red")translate([90,20+Z_BLOCK_LENGTH_V3,Z_BLOCK_HEIGHT*1.2-Z_BLOCK_CLEARANCE])rotate([180,0,0])orca_z_axis_lm8uu_double();

color("purple")translate([20,180,Z_BLOCK_HEIGHT*1.2-Z_BLOCK_CLEARANCE])rotate([180,0,0]) orca_lm8uu_v4();
color("purple")translate([20+(Z_BLOCK_WIDTH*1)+5,180,Z_BLOCK_HEIGHT*1.2-Z_BLOCK_CLEARANCE])rotate([180,0,0]) orca_lm8uu_v4();
color("purple")translate([20+(Z_BLOCK_WIDTH*2)+10,180,Z_BLOCK_HEIGHT*1.2-Z_BLOCK_CLEARANCE])rotate([180,0,0]) orca_lm8uu_v4();
color("purple")translate([20+(Z_BLOCK_WIDTH*3)+15,180,Z_BLOCK_HEIGHT*1.2-Z_BLOCK_CLEARANCE])rotate([180,0,0]) orca_lm8uu_v4();
...
color("DeepSkyBlue")translate([80,100,0])rotate([90,0,0])z_nut_holder();
color("DeepSkyBlue")translate([80,120,0])rotate([90,0,0])z_nut_holder();
color("DeepSkyBlue")translate([80,140,0])rotate([90,0,0])z_nut_holder();
color("DeepSkyBlue")translate([50,95,0])rotate([90,0,0])z_nut_holder();
