...
include <orca_simple_lm8uu_bearings_v5.scad>;
...
BELT_CLAMP_HEIGHT = 22 +CAR_THICKNESS;
...
module car_body()
{
	...
	union()
	{
		...
		translate([14.5,(Z_BLOCK_LENGTH/2)-BELT_OFFSET_Y,-BELT_CLAMP_HEIGHT-2])
		rotate([90,0,0])
		...
		translate([29+DIM_X,(Z_BLOCK_LENGTH/2)-BELT_OFFSET_Y,-BELT_CLAMP_HEIGHT-2])
		rotate([90,0,0])
		%import("y_belt_tensioner_v2_strap.stl", convexity =5);
...
difference()
{
	...
	translate([-1,(BELT_CLAMP_LENGTH-BELT_CLAMP_HOLE_RAD+0.65)/2,BELT_CLAMP_HEIGHT-CAR_THICKNESS-7.5])rotate([0,90,0])
		...
		translate([BELT_CLAMP_WIDTH/2,BELT_CLAMP_LENGTH+2,4])
		rotate([90,0,0])
		#clamp_holes();
