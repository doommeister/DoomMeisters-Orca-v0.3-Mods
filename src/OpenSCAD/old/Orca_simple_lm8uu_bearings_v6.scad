...
color("blue")translate([42,20+Z_BLOCK_LENGTH_V3,Z_BLOCK_HEIGHT*1.2-Z_BLOCK_CLEARANCE])rotate([180,0,0])orca_z_axis_lm8uu_single();
...
color("DeepSkyBlue")translate([165,45,0])rotate([90,0,0])z_nut_holder();
color("DeepSkyBlue")translate([165,23,0])rotate([90,0,0])z_nut_holder();
color("DeepSkyBlue")translate([75,140,0])rotate([90,0,0])z_nut_holder();
color("DeepSkyBlue")translate([50,97,0])rotate([90,0,0])z_nut_holder();

//imports
color("yellow")translate([200,61,0])rotate([0,0,90])import("HallOholderMendelCut.stl", convexity = 5);
...
color("gold")translate([102,120,0])rotate([0,0,180])import("DoomMeisters_Orca_V0.3_X_Carriage_v4.stl", convexity = 5);
