...
echo (lm8uu_holder_width, lm8uu_holder_length, lm8uu_holder_height);
...
module lm8uu_bearing_holder()
{
	difference()
	{
		...
		cylinder(r=lm8uu_diameter/2,h=lm8uu_length,$fn=100);

		translate([lm8uu_holder_width/2,0,lm8uu_holder_width/2])
		rotate([-90,0,0])
		translate([0,0,-1])
		{
			cylinder(r=lm8uu_end_diameter/2,h=lm8uu_holder_length+2,$fn=100);
